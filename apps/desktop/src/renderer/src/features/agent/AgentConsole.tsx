...
import { TaskStateView } from "../task/TaskStateView.js"
...
export function AgentConsole({ events, taskId }: { events: EventRecord[]; taskId?: string | undefined }) {
  ...
  return <div className="agent-content" aria-live="polite">
    ...
    {view.done.length ? <ToolActivity items={view.done} /> : null}
    ...
    <TaskStateView status={view.status} message={view.statusMessage} />
